...
import bandNameImage from "../public/bandnamelogo_img.png";
import bandPhoto from "../public/band_phot.png";

function LinksBar() {
  return (
    <div className="justify-center max-w-sm sm:w-auto sm:fixed sm:right-0 sm:top-16 bg-black flex sm:flex-col">
      <div className="p-3">
        <svg
...
function Frontpage() {
  return (
    <div className="w-full text-gray-900" id="home">
      ...
      <div className=" my-12 sm: my-20 text-3xl sm:text-5xl font-bold uppercase text-center text-shadow">
        Album out now
      </div>
      <div className="sm:w-3/4 flex mx-auto">
        <Image
